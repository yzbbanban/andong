package com.yzb.andong.config.security;
        ...
        if (binaryData == null) {
            ...
            if (lengthDataBits == 0) {
                ...
                for (int val1 = 0; val1 < numberTriplets; ++val1) {
                    ...
                    var17[encodedIndex++] = LOOK_UP_BASE_64_ALPHABET[val21 | var18 << 4];
                    var17[encodedIndex++] = LOOK_UP_BASE_64_ALPHABET[var19 << 2 | val3];
                ...
                if (fewerThan24bits == 8) {
                    ...
                    var17[encodedIndex++] = LOOK_UP_BASE_64_ALPHABET[var23];
                    var17[encodedIndex++] = LOOK_UP_BASE_64_ALPHABET[val2 | var18 << 4];
